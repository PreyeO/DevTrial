...
import SignupImage from "../../assets/girl-talent.gif";
  ...
  return (
    <main className="font-plusJakarta flex-1 text-white">
      <div className="container mx-auto">
        <div className="card flex xl:justify-between justify-center items-center">
          <div>
            <img
              src={SignupImage}
              alt="image of a talent for signup"
              className="w-[40rem]  hidden xl:block signup-image"
            />
          </div>
          <div className="">
